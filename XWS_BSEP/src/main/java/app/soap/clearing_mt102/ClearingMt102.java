...
public class ClearingMt102 {
    ...
    //@Column
   // @XmlElement(name = "pojedinacno_placanje")
    //@ElementCollection(targetClass=PojedinacnoPlacanje.class) 
   // protected ArrayList<PojedinacnoPlacanje> pojedinacnoPlacanje;
 ...
 //   @JoinColumn(name = "pojedinacno_id")
    ...
    protected List<PojedinacnoPlacanje> pojedinacnoPlacanje = new ArrayList<PojedinacnoPlacanje>();
